...
class CustomerPhotoPolicy
{
    ...
    {
        return $user->can('view_any_customer::photo');
    }
    ...
    {
        return $user->can('view_customer::photo');
    }
    ...
    {
        return $user->can('create_customer::photo');
    }
    ...
    {
        return $user->can('update_customer::photo');
    }
    ...
    {
        return $user->can('delete_customer::photo');
    }
    ...
    {
        return $user->can('delete_any_customer::photo');
    }
    ...
    {
        return $user->can('force_delete_any_customer::photo');
    }
