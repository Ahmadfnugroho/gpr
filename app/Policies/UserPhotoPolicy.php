...
class UserPhotoPolicy
{
    ...
    {
        return $user->can('view_any_user::photo');
    }
    ...
    {
        return $user->can('view_user::photo');
    }
    ...
    {
        return $user->can('create_user::photo');
    }
    ...
    {
        return $user->can('update_user::photo');
    }
    ...
    {
        return $user->can('delete_user::photo');
    }
    ...
    {
        return $user->can('delete_any_user::photo');
    }
    ...
    {
        return $user->can('force_delete_any_user::photo');
    }
     ...
     */
    public function replicate(User $user, UserPhoto $userPhoto): bool
    {
