...
class ProductAvailabilityPolicy
{
     ...
     */
    public function view(User $user, ProductAvailability $productAvailability): bool
    {
     ...
     */
    public function update(User $user, ProductAvailability $productAvailability): bool
    {
     ...
     */
    public function delete(User $user, ProductAvailability $productAvailability): bool
    {
     ...
     */
    public function forceDelete(User $user, ProductAvailability $productAvailability): bool
    {
     ...
     */
    public function restore(User $user, ProductAvailability $productAvailability): bool
    {
     ...
     */
    public function replicate(User $user, ProductAvailability $productAvailability): bool
    {
