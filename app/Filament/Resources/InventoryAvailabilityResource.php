...
{
    protected static ?string $model = Product::class; // Using Product as base but will show both

    protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    protected static ?string $navigationGroup = 'Inventory Management';
    protected static ?string $navigationLabel = 'Inventory Availability';
    protected static ?int $navigationSort = 25;
    protected static ?string $slug = 'inventory-availability';
            ...
            ->filters([
                ...
                SelectFilter::make('availability_status')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        ...
                        // For now, return the query as is - filtering will be done in a future iteration
                        return $query;
                    }),
            ])
            ->actions([
