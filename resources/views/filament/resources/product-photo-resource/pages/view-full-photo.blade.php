        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">
                    Foto Produk - {{ $productPhoto->product->name }}
                </h3>
                <p class="text-sm text-gray-600 mt-1">
                    Diupload: {{ $productPhoto->created_at?->format('d M Y H:i') }}
                </p>
            </div>
            ...
            <div class="text-center">
                ...
                <img
                    src="{{ Storage::disk('public')->url($productPhoto->photo) }}"
                    alt="Foto Produk {{ $productPhoto->product->name }}"
            ...
            <div class="mt-4 text-center">
                @if($productPhoto->photo)
                <a
                    href="{{ Storage::disk('public')->url($productPhoto->photo) }}"
                    target="_blank"
